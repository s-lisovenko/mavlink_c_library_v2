...
#define MAVLINK_STANDARD_XML_HASH 5220637972765540215
...
#define MAVLINK_MESSAGE_CRCS {{0, 50, 9, 9, 0, 0, 0}, {148, 178, 60, 78, 0, 0, 0}, {300, 217, 22, 22, 0, 0, 0}, {9500, 85, 252, 252, 0, 0, 0}}
#endif
...
#include "../payload_controller/payload_controller.h"


#if MAVLINK_STANDARD_XML_HASH == MAVLINK_PRIMARY_XML_HASH
# define MAVLINK_MESSAGE_INFO {MAVLINK_MESSAGE_INFO_HEARTBEAT, MAVLINK_MESSAGE_INFO_AUTOPILOT_VERSION, MAVLINK_MESSAGE_INFO_PROTOCOL_VERSION, MAVLINK_MESSAGE_INFO_PAYLOAD_CONTROLLER_API_MESSAGE}
# define MAVLINK_MESSAGE_NAMES {{ "AUTOPILOT_VERSION", 148 }, { "HEARTBEAT", 0 }, { "PAYLOAD_CONTROLLER_API_MESSAGE", 9500 }, { "PROTOCOL_VERSION", 300 }}
